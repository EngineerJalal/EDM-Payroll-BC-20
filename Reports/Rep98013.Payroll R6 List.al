report 98013 "Payroll R6 List"
{
    // version EDM.IT,EDM.HRPY1

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports Layouts/Payroll R6 List.rdlc';
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            column(VarRegNoCo; CompanyInfo."Registration No.")
            {
            }
            ...
            column(VarRegNo; Employee."Register No.")
            {
            }
            ...
            column(VarStDay; VarStDay)
            {
            }
            column(EligibleChild; EligibleNumber)
            {
            }
            ...
            column(NbofChilds; Employee."Don't Deserve Family Allowance")
            {
            }
            ...
            column(VarStDate; VarStDate)
            {
            }
            column(VarEndDate; VarEndDate)
            {
            }
            column(VarPerFinNo; Employee."Personal Finance No.")
            {
            }
            ...
            begin
                ...
                Employee.SETFILTER(Employee."Employment Date", '<' + FORMAT(VarEndDate));
                ...
                if (Employee."Employment Date" >= VarStDate) and (Employee."Employment Date" <= VarEndDate) then
                    VarStDate := Employee."Employment Date";
                ...
                CompanyInfo.GET;
                VarMonthly := 'X';
                RecEmployee.SETFILTER(RecEmployee."Employment Date", '< 01/01/' + FORMAT(VarYear + 1));
                ...
                if PayElement.FIND('-') then
                    if PayElement."R6 No." <> '' then
                        repeat
                            ...
                            PayWorkSheet.SETRANGE(Period, DATE2DMY(VarFPeriod, 2), DATE2DMY(VarEndDate, 2));
                ...
                PayLedgerEntry.SETRANGE(Period, DATE2DMY(VarFPeriod, 2), DATE2DMY(VarEndDate, 2));
                ...
                if PayLedgerEntry.FindFirst then
                    repeat
                        ...
                        if (PayLedgerEntry."Family Allowance" >= 60000) and (Employee.Gender = Employee.Gender::Male) then begin
                            if not PayLedgerEntry."Spouse Secured" then begin
