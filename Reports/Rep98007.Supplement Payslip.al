report 98007 "Supplement Payslip"
{
    // version EDM.HRPY1

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports Layouts/Supplement Payslip.rdlc';
    ...
    dataset
    {
        dataitem("Pay Detail Header"; "Pay Detail Header")
        {
            ...
            dataitem("Pay Detail Line"; "Pay Detail Line")
            {
                ...
                DataItemTableView = SORTING("Employee No.", "Line No.") WHERE("Payment Category" = FILTER(Supplement));
                ...
                begin
                    ...
                    if PreEmp <> "Pay Detail Line"."Employee No." then begin
                        ...
                        PayDetailLine.SETRANGE("Payment Category", "Payment Category"::"Supplement");
                    ...
                    PayrollLedgerEntry.SETRANGE("Payment Category", "Payment Category"::Supplement);
    ...
    var
        ...
        Comment: Text[80];
        HumanResourceCommentLine: Record "HR Comment Line EDM";
